...
- The lower panel shows the informatins of all genes located in this region, and users can select and click the gene to highlight it. Here we select MYC gene.
...
- The lower panel is the embedded IGV Epigenitic Track Viewer. Users can search and select epigenetic data from the ENCODE Portal or upload their own epigenetic data to annotate the interactions.
...
- The middle panel shows one of the simulated 3D single-cell chromatin structure.
